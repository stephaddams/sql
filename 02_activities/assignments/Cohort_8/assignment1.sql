...
CASE WHEN  product_qty_type = 'unit' THEN 'unit'
 ELSE 'bulk' END prod_qty_type_condensed
FROM product ;
...
--How many times PER booth
SELECT vendor_id, booth_number, count(*)
FROM vendor_booth_assignments
...
group by customer_id, strftime('%m', market_date) ,
